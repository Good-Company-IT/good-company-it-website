...
const HowWeDo = () => {
    ...
    return (
        <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 min-h-screen pb-12 pt-80 sm:pt-80 md:pt-80 lg:pt-56 xl:pt-44 overflow-hidden transition-all duration-300 ease-in-out">
            {/* Overlay Image */}
            <div
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-300 ease-in-out">
                ...
                <div className="relative">
                                ...
                                <div className="p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center order-1 lg:order-2 transition-all duration-300 ease-in-out flex-1 lg:h-full overflow-y-auto">
                                    <div className="py-6 sm:py-8 md:py-10 lg:py-8">
                                        <div className="flex gap-x-2 sm:gap-x-3 md:gap-x-4 items-start sm:items-center mb-4 sm:mb-6 text-primary-blue transition-all duration-300 ease-in-out">
                                            <GoShieldCheck className='w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 flex-shrink-0 mt-1 sm:mt-0 transition-all duration-300 ease-in-out' />
                                            <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold leading-tight transition-all duration-300 ease-in-out">
                                                {slides[activeSlide].title}
                                            </h3>
                                        </div>

                                        <p className="text-text-dark text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8 transition-all duration-300 ease-in-out">
                                        ...
                                        <div className="space-y-2 sm:space-y-3 transition-all duration-300 ease-in-out">
                                            {slides[activeSlide].features.map((feature, index) => (
                                                <div key={index} className="flex gap-x-2 sm:gap-x-3 md:gap-x-4 items-start transition-all duration-300 ease-in-out">
                                                    <BiCheckCircle className='text-primary-blue h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 flex-shrink-0 mt-0.5 sm:mt-0 transition-all duration-300 ease-in-out' />
                                                    <span className="text-gray-700 text-xs sm:text-sm md:text-base leading-relaxed transition-all duration-300 ease-in-out">{feature}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                    ...
                    <div className="flex sm:hidden justify-center mt-6 space-x-4">
                        <button
                            onClick={prevSlide}
                            className="w-12 h-12 bg-primary-orange hover:bg-secondary-orange rounded-full flex items-center justify-center transition-all duration-300 shadow-lg active:scale-95"
                            aria-label="Previous slide"
                        >
