...
const QuoteCard = ({ 
  ...
  const getCardHeight = () => {
    return size === 'large' ? 'h-[445px]' : 'h-[285px]';
  };

  return (
    <div className="flex flex-col items-center w-[400px]">
      {/* Top Vertical Line */}
      <div className="w-0.5 h-60 bg-orange-500" />
      
      {/* Quote Card */}
      <div className={`relative w-[400px] ${getCardHeight()} rounded-2xl overflow-hidden group cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl`}>
        {/* Background Image */}
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-6">
          ...
          <div className="flex justify-start mb-4">
            <div className="text-blue-400 text-5xl font-bold leading-none">
              "
            </div>
          </div>
          ...
          <div className="flex-1 flex items-center">
            <blockquote className="text-white text-base font-medium leading-relaxed">
              {quote}
            </blockquote>
          </div>
