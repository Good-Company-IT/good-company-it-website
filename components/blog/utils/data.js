...
export const fetchBlogData = async () => {
  try {
    ...
    if (!data.data || !Array.isArray(data.data)) {
      ...
      return [MOCK_BLOG_42, MOCK_BLOG_43, MOCK_BLOG_44, MOCK_BLOG_47, MOCK_BLOG_51, MOCK_BLOG_56, MOCK_BLOG_57];
    }
    ...
    const staticBlogs = [MOCK_BLOG_42, MOCK_BLOG_43, MOCK_BLOG_44, MOCK_BLOG_47, MOCK_BLOG_51, MOCK_BLOG_56, MOCK_BLOG_57];
